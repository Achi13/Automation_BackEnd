...
public class TestcaseActualData {
	...
	public TestcaseActualData(DependentTestcase testcaseNumber, String inputOutputValue, String label,
			String natureOfAction, String remarks, String screenshotPath, boolean isScreenCapture, String timestamp,
			boolean isTriggerEnter, String webElementName, String webElementNature, String logField,
